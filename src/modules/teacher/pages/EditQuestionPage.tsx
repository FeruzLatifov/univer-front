...
import { useQuestion, useUpdateQuestion } from '@/hooks/useTests'
...
export default function EditQuestionPage() {
  ...
  const { data: questionData, isLoading } = useQuestion(testId, qId)
  ...
  const onSubmit = (values: FormValues) => {
    updateMutation.mutate({ testId, questionId: qId, data: values }, {
      onSuccess: () => {
