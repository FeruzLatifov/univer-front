...
import { addTestQuestion } from '@/lib/api/tests'
...
export default function CreateQuestionPage() {
  ...
  const createMutation = useMutation({
    mutationFn: (data: any) => addTestQuestion(testId, data),
    onSuccess: () => {
    ...
    onError: (error: any) => {
      toast({
        title: 'Xatolik',
        description: error.response?.data?.message || 'Savol qo\'shishda xatolik',
        variant: 'destructive',
      })
    },
  })
