...
import { getTest, deleteTest, publishTest, unpublishTest } from '@/lib/api/tests'
...
export default function TestDetailPage() {
  ...
  const deleteMutation = useMutation({
    ...
    onError: (error: any) => {
      toast({
        title: 'Xatolik',
        description: error.response?.data?.message || 'Test o\'chirishda xatolik',
        variant: 'destructive',
      })
    },
  })
  ...
  const publishMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: 'Muvaffaqiyatli',
        description: 'Test nashr qilindi',
      })
    },
  })

  const unpublishMutation = useMutation({
    mutationFn: () => unpublishTest(testId),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['test', testId] })
      toast({
        title: 'Muvaffaqiyatli',
        description: 'Test nashrdan olindi',
      })
    },
  })
