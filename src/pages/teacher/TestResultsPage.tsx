...
import { getTest, getTestResults, exportTestResults } from '@/lib/api/tests'
...
export default function TestResultsPage() {
  ...
  const { data: resultsData, isLoading } = useQuery({
    queryKey: ['test-results', testId, page, searchQuery, statusFilter],
  ...
  const handleExport = async () => {
    try {
      await exportTestResults(testId)
      toast({
